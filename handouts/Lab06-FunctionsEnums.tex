...
\url{https://github.com/clptrsn/CSCE155-C-Lab06}
...
\begin{enumerate}
  ...
  \item Hand in your \mintinline{text}{colorUtils.c}, \mintinline{text}{colorUtils.h}, and \mintinline{text}{colorUtilsTesterCmocka.c} source file by pointing your browser to:
